...
void motor_setPulseWidth(MotorCmdTypeDef *motor)
{
    ...
    // Update PulseWidth
    TIM_SetCompare1(TIM3, (uint32_t)(997.0f * motor->Motor1Pulse));
    TIM_SetCompare2(TIM3, (uint32_t)(997.0f * motor->Motor2Pulse));
    TIM_SetCompare3(TIM3, (uint32_t)(997.0f * motor->Motor3Pulse));
    TIM_SetCompare4(TIM3, (uint32_t)(997.0f * motor->Motor4Pulse));
}
...
void motor_init()
{
    ...
    TIM3_InitStructure.TIM_Prescaler = 26;
    TIM3_InitStructure.TIM_CounterMode = TIM_CounterMode_Up;
    TIM3_InitStructure.TIM_Period = 19940;
