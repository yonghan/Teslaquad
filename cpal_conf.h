...
#define _CPAL_TIMEOUT_INIT()           CPAL_TimeOutManagerInit();\
...
#define _CPAL_TIMEOUT_DEINIT()         TIM_DeInit(TIM9)        /*<! Disable the systick timer */


#define CPAL_I2C_TIMEOUT_Manager        TIM1_BRK_TIM9_IRQHandler      /*<! This callback is used to handle Timeout error.
